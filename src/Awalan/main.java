...
public class main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Hayy, welcome.");

        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Solusi Cepat, Praktis, dan Akurat untuk Pengelolaan Tiket");

        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Aplikasi ini dirancang untuk memudahkan dalam: ");

        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("1.Mengelola Pemesanan Tiket: Proses reservasi tiket jadi lebih cepat dan efisien. ");

        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("2.Pencatatan Penjualan: Semua transaksi tercatat dengan rapi dan terorganisir. ");

        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("3.Laporan Real-Time: Monitoring penjualan dan kinerja kapan saja, di mana saja.");

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/komponen/20241120_094605.png"))); // NOI18N
